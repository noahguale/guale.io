      ...
      <div className="flex items-center justify-center ">
        <div className="grid grid-cols-1 w-5/12 place-items-center gap-10">
          <div className="flex flex-row place-items-center justify-start w-full">
            <a
              href="/projects"
              className="pr-3 text-sky-300 hover:underline underline-offset-4"
            >
              Projects
            </a>
            <div className="pr-2 text-white text-xs font-bold text-center">
              -
            </div>
            <div className="text-lg font-bold text-white pr-2">
              {" "}
              {postData.title}{" "}
            </div>
            <div className="text-xs hover:underline-offset-1 font-semibold text-white  bg-gray-900/95  shadow-surface-glass backdrop-blur will-change-transform [@supports(backdrop-filter:blur(0px))]:bg-white/[3%] rounded object-cover object-center p-1">
              {" "}
              2023{" "}
            </div>
          </div>
          ...
          <div className="grid grid-col-2 gap-4 place-items-start">
            <div className="flex flex-row place-items-start justify-center">
              <div className="text-xs font-bold text-white bg-sky-500 rounded object-cover object-center p-1">
                {" "}
                WEBSITE{" "}
              </div>
              <a className="pl-3 text-fuchsia-300">
                {postData.website} <span> </span>
              </a>
            </div>
            ...
            <div className="flex flex-row place-items-center justify-center">
              ...
              <div className="pl-3 text-fuchsia-300">
                {postData.blogpost}
                <span> </span>
              </div>
            </div>
