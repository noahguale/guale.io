...
```markdown
PROJECT_ROOT ├── src # Source │ └── pages # Pages │ └── api # API routes │ └──
components # React components │ └── styles # Styling ├── public ├──
transcription # Python scripts ├── uploads # Temporary files └── utils # Utility
tools
```
