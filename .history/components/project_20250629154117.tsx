...
const getProjectIcon = (iconName: string): React.ReactNode => {
	const iconMap: Record<string, React.ReactNode> = {
		openai: <OpenAI className='h-8 w-8' />,
		python: <Python className='h-8 w-8' />,
		nextjs: <Nextjs className='h-8 w-8' />,
		typescript: <TypeScript className='h-8 w-8' />,
		tailwind: <TailwindCSS className='h-8 w-8' />,
		flowframe: <Flowframe className='h-8 w-8' />,
	}
	return iconMap[iconName] || <Cog className='h-8 w-8' />
}
