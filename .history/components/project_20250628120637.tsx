...
export function Project({
	...
	return (
		<div
			className={`border-border flex h-64 flex-1 flex-col border-2 border-dashed p-4 ${
				featured ? 'border-primary' : 'border-dashed'
			}`}
		>
...
export const Projects = ({ projects }: { projects: ProjectProps[] }) => {
	return (
		<div className='w-fu;; grid grid-cols-1 gap-4 md:grid-cols-2'>
