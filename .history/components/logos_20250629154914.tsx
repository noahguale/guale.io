...
function Merkato(props: SVGProps<SVGSVGElement>) {
	return (
		<svg
			xmlns='http://www.w3.org/2000/svg'
		...
		>
          ...
          `}
			...
			<g id='Layer_2'>
				<g>
					<path className='cls-2' d='M540,328.6v-140.9h-140.9' />
					<path
						className='cls-2'
					...
					/>
					<path className='cls-2' d='M187.7,540h70.5' />
					<path className='cls-2' d='M434.3,504.8v70.5' />
					<path className='cls-2' d='M645.7,504.8v70.5' />
					<path className='cls-2' d='M821.9,540h70.5' />
				</g>
			</g>
		</svg>
	)
